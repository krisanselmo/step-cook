    ...
    >
      ...
      <div className="max-w-5xl w-full flex flex-col h-[90vh] gap-6">
        ...
        <div className="flex w-full md:hidden mb-4 justify-center">
          <div
            className={`inline-flex ${theme.properties.radius} overflow-hidden border ${t('border-gray-700', 'border-gray-200')}`}
          >
            <button
        ...
        <div className="grid md:grid-cols-3 gap-6 flex-1 overflow-hidden">
          ...
          <div
            className={`${activeTab === 'mealie' ? 'flex' : 'hidden'} md:flex flex-col ${theme.properties.radius} border shadow-xl overflow-hidden transition-colors ${t(theme.colors.cardBgDark, theme.colors.cardBgLight)}`}
          >
            <div
              className={`p-4 border-b flex flex-col gap-3 ${t('border-gray-800/50', 'border-gray-100')}`}
            >
                  ...
                  {filteredRecipes.map(r => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p
                          className={`text-xs truncate ${t('text-gray-400', 'text-gray-500')}`}
                        >
          ...
          <div
            className={`${activeTab === 'gemini' ? 'flex' : 'hidden'} md:flex flex-col p-4 ${theme.properties.radius} border shadow-xl transition-colors ${t(theme.colors.cardBgDark, theme.colors.cardBgLight)}`}
          >
            <h2 className="font-bold mb-2 text-sm uppercase tracking-wider text-gray-500">
              Assistant Gemini
            </h2>
