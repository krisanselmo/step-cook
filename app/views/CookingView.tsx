...
interface CookingViewProps {
  ...
  setCheckedIngredients: ReturnType<typeof useCookingState>['setCheckedIngredients'];
  ...
  handleIngredientAction: ReturnType<typeof useCookingState>['handleIngredientAction'];
